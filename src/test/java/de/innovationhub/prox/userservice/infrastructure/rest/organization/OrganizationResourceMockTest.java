...
class OrganizationResourceMockTest {
  ...
  void shouldReturnCreated() {
    ...
    .then()
        .statusCode(201)
        .body("name", Matchers.equalTo("Musterfirma GmbH & Co. KG"))
        .body("id", Matchers.not(Matchers.emptyOrNullString()))
        .body("owner", Matchers.equalTo("00000000-0000-0000-0000-000000000000"));
  ...
  void shouldReturnOk() {
    ...
    .then()
        .statusCode(200)
        .body("organizations", Matchers.hasSize(1))
        .body("organizations[0].id", Matchers.equalTo("00000000-0000-0000-0000-000000000000"))
        .body("organizations[0].name", Matchers.equalTo("Musterfirma GmbH & Co. KG"))
        .body("organizations[0].owner", Matchers.equalTo("00000000-0000-0000-0000-000000000000"));
